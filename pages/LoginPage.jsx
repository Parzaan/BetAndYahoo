...
export default function LoginPage({ onLoginSuccess, onToggleSignUp }) {
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-neutral-950 text-white relative overflow-hidden">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-neutral-400 mt-2">Sign in to continue to Bet NYahoo</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-neutral-400">
          ...
          <button onClick={onToggleSignUp} className="text-blue-400 hover:text-blue-300 transition-colors font-medium">
            Sign Up
          </button>
        </div>
      </motion.div>
